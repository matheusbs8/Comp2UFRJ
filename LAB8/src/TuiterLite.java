...
public class TuiterLite <T>{
     ...
     */
    public Tuite tuitarAlgo(Usuario usuario, String texto) throws UsuarioDesconhecidoException, TamanhoZeradoException, TamanhoMaximoExcedidoException {
        ...
        if ( texto.length() == 0){
            throw new TamanhoZeradoException();
        }
