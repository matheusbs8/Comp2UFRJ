...
public class TuiterLiteTest {
    ...
    public void testeAutorDoTuite()
            throws UsuarioDesconhecidoException, TamanhoZeradoException, TamanhoMaximoExcedidoException {
...
//    }
    ...
    @Test
    public void testeTamanhoTuite() throws UsuarioDesconhecidoException, TamanhoZeradoException, TamanhoMaximoExcedidoException  {
...
//                    "o máximo permitido", tuiterLite.tuitarAlgo(usuario, texto));
    ...
    public void testeApenasUmTipoPermitidoComoAnexo()
            throws TamanhoMaximoExcedidoException, UsuarioDesconhecidoException, UsuarioJaExisteException, TamanhoZeradoException {
...
//        tuite.anexarAlgo(new Object());  // essa linha, se fosse descomentada, daria erro de compilação
    ...
    @Test
    public void testarMultiplosSimbolosDeHashtag() throws UsuarioDesconhecidoException, TamanhoZeradoException, TamanhoMaximoExcedidoException {
...
//
    ...
    /////
    @Test
    public void testePerformanceTuites() throws UsuarioJaExisteException, TamanhoZeradoException, TamanhoMaximoExcedidoException {
    ...
    @Test
    public void testeUsuarioNulo()throws UsuarioDesconhecidoException, TamanhoZeradoException, TamanhoMaximoExcedidoException {

        try {
            tuiterLite.tuitarAlgo(null, "texto teste");
            fail("Um usuário Nulo deve lançar uma IllegalArgumentException");
    ...
    @Test
    public void testeTextoNulo()throws UsuarioDesconhecidoException, TamanhoZeradoException, TamanhoMaximoExcedidoException {

        try {
            tuiterLite.tuitarAlgo(usuario, null);
            fail("Um tuite nulo deve lançar uma IllegalArgumentException");
    ...
    @Test
    public void testeUsuarioDesconhecido()throws UsuarioDesconhecidoException, TamanhoZeradoException, TamanhoMaximoExcedidoException {

        try {
            Usuario novoU = new Usuario("nome","email");
            tuiterLite.tuitarAlgo(novoU, "texto teste");
            fail("Um usuário desconhecido deve lançar uma UsuarioDesconhecidoException");
    ...
    @Test
    public void testeTamanhoZerado()throws UsuarioDesconhecidoException, TamanhoZeradoException, TamanhoMaximoExcedidoException {

        try {
            tuiterLite.tuitarAlgo(usuario, "");
            fail("Um tuite zerado deve lançar uma TamanhoZeradoException");

        } catch (TamanhoZeradoException e) {

        }
    }

    @Test
    public void testeTamanhoExcedido()throws UsuarioDesconhecidoException, TamanhoZeradoException, TamanhoMaximoExcedidoException {
        String s="";
        for(int i=0; i<TuiterLite.TAMANHO_MAXIMO_TUITES+10; i++){
            s+=" ";
        }
        try {
            tuiterLite.tuitarAlgo(usuario, s);
            fail("Um tuite maior do que o tamanho máximo deve lançar uma TamanhoMaximoExcedidoException");
